...
import '../Main/Main.css'; // Importa los estilos
    ...
    return (
        <>
            <div className="main-container pt-5">
                <div className='bg-warning'>a</div>
                <div style={{ width: "100%", display: "flex", justifyContent: "center", alignItems: "center" }}>
                    <Link to="/" className="btn-move-page-link mb-4"><HouseDoor /></Link>
                </div>
                {loading ? (
                    ...
                    <div className="image-and-cards-container">
                        <div className="cards-container">
                            {nearvyPlaces.map((place, index) => {
                                const imgSrc = new URL(`../../assets/img/${place.image}`, import.meta.url).href;
                                return (
                                    <Card
                                        key={place.id}
                                        index={index + 1}
                                        ...
                                        image={imgSrc} // Usa la ruta de la imagen importada
                ...
                <div className="container m-3 d-flex flex-column justify-content-center align-items-center p-3" style={{ background: "#083758", color: "white", textAlign: "center" }}>
                    <p>"Las Cevicherías al paso" que se muestran en el listado, son consideradas las mejores de Chiclayo.</p>
